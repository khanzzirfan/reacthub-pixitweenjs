...
import { applyEventProps } from "./applyEventProps";
import type {
  ITransformerCursors,
  ITransformerStyle,
...
>("Transformer", {
  ...
  applyProps(
    ...
    if (oldProps.rotationSnapTolerance !== newProps.rotationSnapTolerance) {
      instance.rotationSnapTolerance = newProps.rotationSnapTolerance || 0;
    }
    ...
    if (oldProps.skewSnapTolerance !== newProps.skewSnapTolerance) {
      instance.skewSnapTolerance = newProps.skewSnapTolerance || 0;
    }
